...
// Nome do produto, sempre sem espaços e caracteres especiais
var nomeProduto = 'Keto 30';

// Menu acompanhar a página. Sim - 1, Não - 0
var menuPage = '0';

// Bloquear botão direito, Ctrl+s, Ctrl+u, F12. Sim - 1, Não - 0
var blockAll = '0';
...
var day = 0,
    ...
    minute = 59,
    seconds = 59;
// Manter valores do contador ao recarregar a pagina. Sim - 1, Não - 0
var everGreen = '1';
// Ao contador terminar, exibir uma mensagem. Sim - 1, Não - 0
var usarMsgContador = '1',
    msgContador = 'Promoção Expirada!';
/*CONTADOR*/

// Direcionar para https. Sim - 1, Não - 0
var https = '0',
    linkHttps = '';

// Redirecionamento ao clicar em voltar. Sim - 1, Não - 0
var redirect = '0',
    linkAtual = '',
    linkRedirect = '';

// Redirecionamento ao confirmar o nao fechamento da pagina. Sim - 1, Não - 0
var redirectClose = '0',
    redirectLinkClose = '';

var timerT = 1000;
$(document).ready(function(){
    /*Liberar restante da página*/
    setTimeout(function(){
        $('#hiddened').show();
    }, 600000);
    ...
    */
    ...
    if (usarNotificacoes == '1') {
        if ($('.test-mobile').css('display') == 'block') {
            setTimeout(function () {
                toastr.info('<a href="' + linkComprar + '">Clique e garanta o seu também!</a>', qtd + ' novas pessoas compraram nos últimos 30min.', {
                    timeOut: 10000,
            ...
            setTimeout(function () {
                toastr.success('<a href="' + linkComprar + '">Clique e garanta o seu também!</a>', Base.getD(acessoC[2]) + ' acabou de comprar.', {
                    timeOut: 5000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*100);
            setTimeout(function () {
                toastr.success('<a href="' + linkComprar + '">Garanta o seu também!</a>', Base.getD(acessoC[3]) + ' acabou de comprar ' + nomeProduto + ' na promoção.', {
                    timeOut: 5000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*200);
            ...
            setTimeout(function () {
                toastr.success('<a href="' + linkComprar + '">Esse preço é por tempo limitado!</a>', Base.getD(acessoC[5]) + ' está comprando agora ' + nomeProduto + '', {
                    timeOut: 5000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*350);
            ...
            setTimeout(function () {
                toastr.info('<a href="' + linkComprar + '">Corra e aproveite a oferta!</a>', qtd + 9 + ' novas pessoas compraram nos últimos 30min.', {
                    timeOut: 20000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*600);
            setTimeout(function () {
                toastr.success('<a href="' + linkComprar + '">Clique e garanta o seu também!</a>', Base.getD(acessoC[7]) + ' acabou de comprar ' + nomeProduto + ' na oferta.', {
                    timeOut: 5000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*620);
            setTimeout(function () {
                toastr.info('<a href="' + linkComprar + '">Corra e aproveite a oferta!</a>', qtd + 11 + ' novas pessoas compraram nos últimos 30min.', {
                    timeOut: 20000,
                    positionClass: "toast-" + ladoNotificacoes,
                })
            }, timerT*1200)
